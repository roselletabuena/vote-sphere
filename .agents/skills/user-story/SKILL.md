...
This is not a feature spec—it's a conversation starter that captures _who_ benefits, _what_ they're trying to do, _why_ it matters, and _how_ you'll know it works.
...
**Consequence:** No insight into _why_ the user cares. Just restating the action.
...
- Mike Cohn, _User Stories Applied_ (2004) — Origin of the "As a / I want / so that" format
